...
BitcoinTBIcon* taskBarIcon = NULL; // Tray icon
...
BEGIN_EVENT_TABLE(BitcoinTBIcon, wxTaskBarIcon)
	EVT_TASKBAR_LEFT_DCLICK  (BitcoinTBIcon::OnLeftButtonDClick)
	EVT_MENU(PU_RESTORE,    BitcoinTBIcon::OnMenuRestore)
	EVT_MENU(PU_GENERATE,    BitcoinTBIcon::OnMenuGenerate)
	EVT_MENU(PU_EXIT,    BitcoinTBIcon::OnMenuExit)
END_EVENT_TABLE()

void BitcoinTBIcon::Show()
{
	SetIcon(wxICON(bitcoin), "Bitcoin");
}

void BitcoinTBIcon::Hide()
{
	RemoveIcon();
}

void BitcoinTBIcon::OnLeftButtonDClick(wxTaskBarIconEvent&)
{
	Restore();
}

void BitcoinTBIcon::OnMenuExit(wxCommandEvent&)
{
	// doesn't work: pframeMain->Close();
}

void BitcoinTBIcon::OnMenuGenerate(wxCommandEvent&)
{

}

void BitcoinTBIcon::OnMenuRestore(wxCommandEvent&) {
	Restore();
}

void BitcoinTBIcon::Restore() {
    pframeMain->Show();
    pframeMain->Raise();
...
wxMenu *BitcoinTBIcon::CreatePopupMenu()
{
    wxMenu *menu = new wxMenu;
    menu->Append(PU_RESTORE, _T("Generate Coins"));
